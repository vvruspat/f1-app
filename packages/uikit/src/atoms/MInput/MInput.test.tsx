...
describe('MInput', () => {
  test('renders', () => {
    render(
      <MInput type="email" placeholder="enter your email address" />
    );
  ...
  test('renders password input type and hides characters', () => {
    render(<MInput type="password" placeholder='enter your password' defaultValue="secret" />);

    const inputElement = screen.getByPlaceholderText<HTMLInputElement>('enter your password');
